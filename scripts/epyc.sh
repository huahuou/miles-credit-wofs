...
# OMP_NUM_THREADS=1 python -m torch.distributed.run --standalone --nnodes 1 --nproc_per_node=1 applications/train_wrf_wofs_multi.py -c /home/zhanxiang.hua/miles-credit-wofs/config/wofscast_credit_wrf_latest.yml
...
# OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 python -m torch.distributed.run --standalone --nnodes 1 --nproc_per_node=2 applications/train_wrf_wofs_da.py -c /home/zhanxiang.hua/scratch/credit_runs/wofs_da_increment_experiment_0413/model.yml
 
OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 python -m torch.distributed.run --standalone --nnodes 1 --nproc_per_node=1 applications/train_wrf_wofs_da.py -c /home/zhanxiang.hua/scratch/credit_runs/wofs_da_increment_experiment_0417/model.yml
