...
# OMP_NUM_THREADS=2 MKL_NUM_THREADS=1 python -m torch.distributed.run --standalone --nnodes 1 --nproc_per_node=2 applications/train_wrf_wofs_da.py -c /home/zhanxiang.hua/miles-credit-wofs/config/wofs_credit_wrf_da_increment.yml
