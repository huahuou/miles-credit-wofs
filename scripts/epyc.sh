...
torchrun --standalone --nnodes 1 --nproc-per-node=1 applications/train_wrf_wofs_da.py -c /home/zhanxiang.hua/miles-credit-wofs/config/wofs_credit_wrf_da_increment.yml
