...
torchrun --standalone --nnodes 1 --nproc-per-node=1 applications/train_wrf_wofs_multi.py -c /home/zhanxiang.hua/miles-credit-wofs/config/wofscast_credit_wrf_0331.yml
