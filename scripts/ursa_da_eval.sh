...
SAVE_PHYSICAL="/scratch5/purged/Zhanxiang.Hua/credit_wofs_da_example/wofs_da_increment_experiment_0423/test6/eval_physical.zarr"                              # Path for physical-space Zarr store.
