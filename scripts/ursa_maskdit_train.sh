...
CONFIG="${PROJECT_DIR}/config/wofs_maskdit_4x4_patch_height_mask.yml"
##CONFIG="${CONFIG:-/scratch3/NAGAPE/gpu-ai4wp/Zhanxiang.Hua/credit_runs/wofs_diffmae_pretrain_latest2-2/model.yml}"
